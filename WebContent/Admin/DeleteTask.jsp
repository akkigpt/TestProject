...
%>
            ...
            <option><%=request.getAttribute("taskCat")%></option>
...
<br><br>
<input type="submit" value="Delete" style="margin-left: 0%;width:80px;height:32px;background-color:#007BC0;color:white" onclick="if (confirm('Are you sure you want to delete?')){form.action='<%=request.getContextPath()%>/AdminDeleteViewTask'}else { return false; };"/>
