...
<tm style="font-family:calibri">Timesheet Management System</tm>
  <user>Welcome jyoti</user>
  </header>
 <div class="HorizontalNav">
<ul><li>
<a class="active" href="${pageContext.request.contextPath}/AdminDashboard">Home</a></li>
  <li class="dropdown">
   ...
   <li class="dropdown">
    <a href="#task" class="dropbtn">Project</a>
    <div class="dropdown-content">
      <a href="${pageContext.request.contextPath}/Admin/AddProjects.jsp">Add Project</a>
      <a href="${pageContext.request.contextPath}/Admin/UpdateProjects.jsp">Update Projects </a>
 ...
 <li class="dropdown">
    <a href="#task" class="dropbtn">User</a>
    <div class="dropdown-content">
      <a href="${pageContext.request.contextPath}/Admin/AddUsers.jsp">Add User</a>
      <a href="${pageContext.request.contextPath}/Admin/UpdateUsers.jsp">Update Users</a>
     </div></li>
       <li class="dropdown">
    <a href="#task" class="dropbtn">Holiday</a>
    <div class="dropdown-content">
